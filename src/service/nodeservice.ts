...
export class NodeService {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                key:'1_2_1',
                label: 'აბაშიძე-ორბელიანის ქ.',
                data: 'აბაშიძე-ორბელიანის ქ.',    
              },
              {
                key:'1_2_2',
                label: 'არჩილ მეფის ქ.',
              ...
              {
                key:'1_2_3',
                label: 'დემეტრე თავდადებულის ქ.',
                data: 'დემეტრე თავდადებულის ქ.',    
              },
              {
                key:'1_2_4',
                label: 'მირიან მეფის ქ.',
                data: 'მირიან მეფის ქ.',    
              }
            ]
          },
          {
            ...
            children: [
              ...
              {
                key:'1_3_3',
                label: 'მელიქ-სურხავის ქ',
                data: 'მელიქ-სურხავის ქ',    
              },
              {
                key:'1_2_4',
                label: 'ვახტანგ ბერიძის ქ.',
                data: 'ვახტანგ ბერიძის ქ.',    
              }
            ]
          }
        ]
        ...
        children: [
          {
            ...
            data: 'აეროპორტის უბანი',
          },
          {
            key:'2_2',
            label: 'აღმაშენებლის უბანი',
            data: 'აღმაშენებლის უბანი',
          },
          {
            key:'2_3',
            label: 'ბაგრატიონის უბანი',
            data: 'ბაგრატიონის უბანი',
          }
        ]
      },
      {
  ...
  getTreeNodesData() {
    return [
      {
        key: '0',
        label: 'ხარისხის კონტროლი, გარემოს დაცვა, უსაფრთხოება',
